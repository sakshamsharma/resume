...
\defaultfontfeatures{
    Path = /home/saksham/.fonts/fontawesome/opentype/ }
...
\begin{experience}
  ...
  \expitemtwo{HTTP-Over-Protocol}{}
  {Prof. Sandeep Shukla}
  {
  \item HTTP wrapper for bypassing proxy restrictions
  \item Allows using arbitrary protocols behind a proxy
  \item Website and code at \href{http://acehack.org/hop}{acehack.org/hop}
  }

  \expitemtwo{Coordinator}{}
  ...
  \expitemtwo{Software Manager}{}{\hfill Techkriti 2016, IIT Kanpur}
  {
  ...
  \expitemtwo{Winning team twice}{Microsoft code.fun.do}{}
  {
