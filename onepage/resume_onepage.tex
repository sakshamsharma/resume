...
\begin{experience}
  ...
  {\href{http://cse.iitk.ac.in/~sandeeps}{Prof. Sandeep Shukla}}
  {
    \item Developing a UDP based video communication protocol robust to network,
      IP changes.
    \item Using stateless UDP and a custom video synchronization
      protocol to ensure reliability, security.
  }

  \expitem{\href{https://github.com/pclubiitk/puppy-love}{\linkbold{Anonymous
        secure pair-matching}}}{Oct'16-Now}
  ...
  \item Using secure two party computation and oblivious transfer to
