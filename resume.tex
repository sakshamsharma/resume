...
\begin{minipage}[t]{0.66\textwidth}
  ...
  \item Contribute sporadically to \textb{Open Source}
    ...
    personal projects
  \item Microsoft \textb{Build The Shield}, qualified first round and were
    National 10th in the onsite round, a competition based on
    offensive, defensive hacking
  \item Read and studied a fair share of \textb{Computer Security} related
  ...
  \item	Attended a full paper-reading seminar-like course on
    \textb{Approximate Computing} during Summer ’16 at the Max Planck
    Institute
  \item \textb{Administer} \onepage{various} servers in IIT Kanpur; deploying,
    automating services
