...
\setlist{nosep}
\usepackage[margin=0.40in, top=0.15in,bottom=0.3in]{geometry}         %% page margins >0.5" and < 1.0"
...
&Programming Languages      &C/C++, Python, Java, Haskell, C\#, Scala\\
...
& Introduction to Programming(A*)  & Abstract Algebra & Logic in Computer Science\\
