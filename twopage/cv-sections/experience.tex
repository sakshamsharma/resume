...
\begin{cventries}
  ...
  {Jul. 2018 - Present}
  {
    ...
    \item {Write efficient and maintainable automated trading systems in C++, which run a massive number of profitable High Frequency Trading strategies of the team all over the world.}
    \item {Develop cutting-edge software in C++ and Python which allow our team to generalize strategies and research across \mbox{exchanges} and products, without compromising speed.}
    \end{cvitems}
  }
